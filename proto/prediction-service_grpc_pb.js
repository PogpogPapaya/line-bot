...
function deserialize_papaya_PredictionRequest(buffer_arg) {
	return prediction$service_pb.PredictionRequest.deserializeBinary(
...
function deserialize_papaya_PredictionResponse(buffer_arg) {
	return prediction$service_pb.PredictionResponse.deserializeBinary(
		new Uint8Array(buffer_arg)
	)
}
...
exports.PapayaServiceClient =
	grpc.makeGenericClientConstructor(PapayaServiceService)
